...
class Frame_Accueil(tk.Frame):
    def __init__(self,parent):
        ...
        tk.Button(self, text="Explication/But du jeu", fg="black", bg="seashell3", font=("arial", 70)).pack(pady=20)
        tk.Button(self, text="Quitter le jeu", fg="black", bg="seashell3", font=("arial", 70),command=parent.destroy).pack(pady=20)
